    ...
    'backend' => [
        'access' => [
            ...
            'accounts' => [
                ...
                'cant_confirm' => 'There was a problem confirming the account account.',
                'cant_deactivate_self' => 'You can not do that to yourself.',
                'cant_delete_admin' => 'You can not delete the super administrator.',
                'cant_delete_self' => 'You can not delete yourself.',
                'cant_delete_own_session' => 'You can not delete your own session.',
                'cant_restore' => 'This account is not deleted so it can not be restored.',
                'cant_unconfirm_admin' => 'You can not un-confirm the super administrator.',
                'cant_unconfirm_self' => 'You can not un-confirm yourself.',
                ...
                'delete_first' => 'This account must be deleted first before it can be destroyed permanently.',
                'email_error' => 'That email address belongs to a different account.',
                'mark_error' => 'There was a problem updating this account. Please try again.',
                'not_confirmed' => 'This account is not confirmed.',
                'not_found' => 'That account does not exist.',
                'restore_error' => 'There was a problem restoring this account. Please try again.',
                'role_needed_create' => 'You must choose at lease one role.',
                'role_needed' => 'You must choose at least one role.',
                'social_delete_error' => 'There was a problem removing the social account from the account.',
                'update_error' => 'There was a problem updating this account. Please try again.',
                'update_password_error' => 'There was a problem changing this accounts password. Please try again.',
            ],
        ],
    ],
