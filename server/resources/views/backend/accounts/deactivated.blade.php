        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted">@lang('labels.backend.access.accounts.deactivated')</small>
                </h4>
            </div><!--col-->
        </div><!--row-->
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        @if($accounts->count())
                            ...
                            @endforeach
                        @else
                            <tr><td colspan="9"><p class="text-center">@lang('strings.backend.access.accounts.no_deactivated')</p></td></tr>
                        @endif
                        </tbody>
                    </table>
                </div>
